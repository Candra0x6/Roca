              ...
              { (poolDetails.state === PoolState.Locked || poolDetails.state === PoolState.Active) && (
                <RevealOnView delay={0.35}>
                  <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-neutral-900/60 p-6">
                    ...
                    <div className="relative z-10">
                      <div className="flex items-center justify-between mb-4">
                        <h3 className="text-lg font-semibold text-white">Yield Management</h3>
                        <Badge className="bg-purple-500/20 text-purple-400 border-purple-500/30">
                          <Shield className="h-3 w-3 mr-1" />
                          Creator
                        </Badge>
                      ...
                      <div className="space-y-4">
                          ...
                          <div className="bg-orange-500/10 border border-orange-500/30 rounded-2xl p-4">
                            ...
                            <div className="space-y-2">
                              ...
                              <Button
                                ...
                                disabled={isSimulating || isUpdatingYield}
                                size="sm"
                                className="w-full rounded-full bg-orange-500/20 hover:bg-orange-500/30 text-orange-300 border-0 text-xs"
                              >
                                {isSimulating ? (
                                  <>
                                    <Loader2 className="h-3 w-3 mr-1 animate-spin" />
                        ...
                        <div className="bg-blue-500/10 border border-blue-500/30 rounded-2xl p-3">
                          <div className="flex items-center gap-2 text-blue-400 text-sm mb-1">
                            ...
                            Pool is generating yield
                          </div>
                          <p className="text-white/70 text-xs">
                            Pool ID: {poolId?.toString() || 'Loading...'}
                          </p>
                        </div>
                      </div>
                    </div>
